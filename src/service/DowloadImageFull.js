...
export async function dowloadImageFull(page,product,elementTitle1,elementTitle2,elementMainImage1,elementMainImage2,elementMainImageVersion1,elementMainImageVersion2,elementSecurity,textCheckSecurity,inputChange,outputChange) {
